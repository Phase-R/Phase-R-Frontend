        ...
        <>
            <div>
                <div className="text-white relative">
                    ...
                    <div className="z-100 xl:absolute lg:absolute xl:inset-0 lg:inset-0 px-20 py-[15%] w-full xl:w-[50%] lg:w-[50%] xl:min-h-[100vh] lg:min-h-[74vh] xl:bg-header-text-bg lg:bg-header-text-bg">
                        <h1 className={`text-3xl xl:text-7xl lg:text-5xl font-bold ${poppins.className}`}>{props.headerHeading.toUpperCase()}</h1>
                        <p className="my-5 text-lg md:text-xl lg:text-2xl w-full xl:w-[75%] lg:w-[75%]">{props.headerDesc}</p>
