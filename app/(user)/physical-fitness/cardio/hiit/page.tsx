...
export default function hiit() {
    ...
    return(
        <div>
            <PageHeader headerHeading="hiit workout" headerDesc="Did you know that your heart doesn't take a vacation? It beats around 100,000 times a day, whether you're awake, asleep, working, or relaxing. Show your heart some appreciation by fitting in a cardio workout—it's like a mini-vacation for your cardiovascular system!" bgImage={"/physical-fitness-page/hiit_bgm.png"} headerColor="bg-orange-500" headerSubtextArray={["SIMPLE CARDIO", "HIIT Workout", "Advanced CARDIO"]} headerDesctextArray={["(20-30 MINS)", "(30 MINS)", "(30-40 MINS)"]} />
            <VidComponent miniTitle="the ultimate" pageTitle="fat burning hiit challenge" pageTitleColor="text-orange-500" pageDesc="Whether you’re working on boosting your fitness or you want to improve your mental health, HIIT is a great form of exercise. You will be allowed only 20 seconds of rest between sets and 60 seconds between exercises." videos={hiitVids} />
        </div>
    );
}