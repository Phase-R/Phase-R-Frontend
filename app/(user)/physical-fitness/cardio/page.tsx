    ...
    return (
        <div>
            ...
            <PageHeader 
                ...
                bgImage={'/physical-fitness-page/cardio_main_bgm.png'} 
                headerSubtextArray={["Simple Cardio", "HIIT Workout", "Advanced Cardio"]} 
                headerDesctextArray={["(20-30 MINS)", "(30 MINS)", "(30-40 MINS)"]} 
            />
            
            <div className="bg-gradient-to-b from-black via-orange-500 to-black min-h-screen text-white text-lg">
                <PageSection 
                    linkTo="/physical-fitness/simple-cardio" 
                    imageUrl="/physical-fitness-page/cardio_main_1.png" 
                ...
                <PageSection 
                    ...
                    imageUrl="/physical-fitness-page/cardio_main_2.png" 
                ...
                <PageSection 
                    ...
                    imageUrl="/physical-fitness-page/cardio_main_3.png" 
