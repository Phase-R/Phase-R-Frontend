...
export default function Badminton_Defense() {
    const vids = [
    ...
    return (
        <div>
            <PageHeader headerHeading="Defense" headerDesc="Badminton is a fast-paced sport requiring agility, precision, and strategy. Players need exceptional skill to dominate with powerful smashes, deft net shots, and tactical positioning." bgImage={"/sports_page/badminton_bg.png"} headerColor="bg-blue-500" />
            <VidComponent miniTitle="Defense" pageTitle="" pageTitleColor="text-orange-500" pageDesc="" videos={vids} />   
        </div>      
    )
}