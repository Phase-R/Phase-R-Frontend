...
export default function Pace() {
    ...
    return (
        <div>
            <PageHeader headerHeading="PACE BOWLING" headerDesc="Cricket is a very old game which requires the utmost of wits, tenacity and discipline combined with a high skill level either with the bat, ball or both" bgImage={"/sports_page/pace.svg"} headerColor="bg-orange-500" />
