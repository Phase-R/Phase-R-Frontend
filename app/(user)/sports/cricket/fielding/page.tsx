...
export default function Fielding() {
    ...
    return (
        <div>
            <PageHeader headerHeading="FIELDING" headerDesc="Cricket is a very old game which requires the utmost of wits, tenacity and discipline combined with a high skill level either with the bat, ball or both" bgImage={"/sports_page/fielding_bg.svg"} headerColor="bg-orange-500" />
            <VidComponent miniTitle="Fielding Drills" pageTitle="" pageTitleColor="text-orange-500" pageDesc="" videos={fieldingBowlingVids} />
        </div>
    )
}