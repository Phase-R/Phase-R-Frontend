...
export default function Keeping() {
    ...
    return (
        <div>
            <PageHeader headerHeading="WICKET-KEEPING" headerDesc="Cricket is a very old game which requires the utmost of wits, tenacity and discipline combined with a high skill level either with the bat, ball or both" bgImage={"/sports_page/keeping_bg.svg"} headerColor="bg-orange-500" />
            <div className="bg-gradient-to-b from-[#000000] via-[#28AABD] to-[#071c1f] min-h-screen py-10">
                <VidComponent miniTitle="Wicket Keeping Drills" pageTitle="" pageTitleColor="text-orange-500" pageDesc="" videos={keepingBowlingVids} />
