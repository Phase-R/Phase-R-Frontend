...
export default function Sports() {
    return (
        <div>
            ...
            <div className="bg-gradient-to-b from-black from-0% via-[#62A0BF] to-black to-100%">
            {/* <div className="bg-gradient-to-b from-[#472411] from-0% via-[#E3C016] via-51% to-[#2A2102] to-100%"> */}
                ...
                <PageSection imageUrl="/sports_page/badminton.png" heading="THE BADMINTON AIM" desc="Badminton is the fastest sport in the world and it requires a great deal of hand-eye coordination and great levels of mental toughness coupled with skill and fitness levels." linkTo="/sports/badminton" />
